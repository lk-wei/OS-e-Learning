...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "SELECT * FROM lecturer WHERE L_Email = ?");
    if (!$stmt) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if (password_verify($password, $user['L_Password'])) {
            ...
            $_SESSION['username'] = $user['L_Username'];
            $_SESSION['email'] = $user['L_Email'];
            $_SESSION['password'] = $user['L_Password'];
            $_SESSION['contactnumber'] = $user['L_Contact_Number'];
...
<body>
    <div class="wrapper">
        ...
        <div class="form-box login">
            ...
            <form action="loginlecturer.php" method="post">
                <div class="input-box">
                ...
                <div class="login-register">
                    <p>Don't have an account?<a href="registerlecturer.php" class="register-link"> Register</a></p>
                </div>
            </form>
        </div>
    </div>
